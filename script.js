...
const startsound = new Audio("./sounds/sounds_gamesound.mp3");
const eatsound = new Audio("./sounds/sounds_eat.mp3");
const movesound = new Audio("./sounds/sounds_move.mp3");
const collidesound = new Audio("./sounds/sounds_gameover.mp3");
let speed = 5;
let lastPaintTime = 0;
let food = { x: 3, y: 20 };
let snakeArray = [
